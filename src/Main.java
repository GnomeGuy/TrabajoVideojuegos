public class Main {
    public static void main(String[] args) {
        ...
        Videojuego v1 = new Videojuego("CSGO","FPS", d1,f2);
        Videojuego v2 = new Videojuego("Gambisima","GambaForce", d1, f2);
        Videojuego v3 = new Videojuego("Pew","Ay",d2,f2);
        t1.agregar(v1);
        t1.agregar(v2);
        t1.agregar(v3);
        ...
        d1.agregar(v1);
        d1.agregar(v2);
        System.out.println(d1.otroJuego());
